from src.loading.breedloader import DogLoader
...
# def test_can_load_data_from_staging_to_rawsadds3(pw_db):
#     loader = DogLoader(pw_db)
#     loader.load_staging('test/integration/data/dogs.csv')
#     loader.load_raw()
#     cursor = pw_db.connection().execute('SELECT * FROM Dog')
#     assert len(cursor.fetchall()) == 40

    
# def test_can_load_data_from_staging_to_rawasdasd2(pw_db):
#     loader = DogLoader(pw_db)
#     loader.load_staging('test/integration/data/dogs.csv')
#     loader.load_raw()
#     cursor = pw_db.connection().execute('SELECT * FROM Dog')
