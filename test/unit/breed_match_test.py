...
@pytest.mark.parametrize('given,real,similarity', [
...
def test_can_get_similarity_for_dog_breed(given, real, similarity):
    assert DogBreedLogic.get_similarity(given, real) == similarity
...
def test_match_exceeding_threshold_will_be_marked_as_onbekend(given, real):
    breedlist = ['aaaaaaaa']
